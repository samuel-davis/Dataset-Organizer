...
public class RecordWriter {
  ...
  private static boolean initialize(
      Path locationAndNameOfRecordToWrite, List<String> headerFields) {
    ...
    try {
      ...
      RecordWriter.intialized = false;
      log.error(
          "Exception encountered attempting to create the record for the restructuring operations. {}",
          e);
    }
    return RecordWriter.intialized;
  }

  private static void writeHeaderFields(List<String> headerFields) throws IOException {
  ...
  public static void writeRecord(List<String> stuffToWrite) throws IOException {
